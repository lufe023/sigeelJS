...
const createOrUpdateSuffrageController = async (
    citizenID,
    suffrageValue,
    registerBy,
) => {
...
const createOrUpdateSuffrageGrupalController = async (
    positions,
    CollegeId,
    suffrageValue,
    registerBy,
    ...
    try {
        ...
        const citizens = await Census.findAll({
            where: {
                ...
                CollegeId, // Asegúrate de que este filtro esté correctamente aplicado
            },
        });
