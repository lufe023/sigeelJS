...
const { extractUserMunicipality } = require("../middlewares/role.middleware");
...
router.get(
    ...
    extractUserSectorPermissions,
    jceServices.getAllPrecintService,
);
...
router.get(
    ...
    passport.authenticate("jwt", { session: false }),
    leaderValidate,
    jceServices.getDataConsistencyService,
);
...
router.post(
    ...
    passport.authenticate("jwt", { session: false }),
    adminValidate,
    jceServices.createPrecintServices,
);
...
router.get(
    "/colleges",
    passport.authenticate("jwt", { session: false }),
    jceServices.getAllCollegeService,
);
...
router.post(
    ...
    passport.authenticate("jwt", { session: false }),
    adminValidate,
    jceServices.createCollegeServices,
);
