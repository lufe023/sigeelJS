...
router.post(
    ...
    passport.authenticate("jwt", { session: false }),
    adminValidate,
    censusServices.getPeopleByUser,
);
...
router.post(
    "/search",
    passport.authenticate("jwt", { session: false }),
    extractUserSectorPermissions, //extraemos solo los ids de sectores parajes permitidos
...
router.post(
    ...
    passport.authenticate("jwt", { session: false }),
    adminValidate,
    censusServices.addPeopleToOtherUser,
);
...
router.patch(
    "/transfercensus",
    passport.authenticate("jwt", { session: false }),
    censusServices.transferCensusService,
);
...
router.get(
    "/pendiente/:citizenId",
    passport.authenticate("jwt", { session: false }),
    censusServices.getPendingUpdatesService,
);
...
router.patch(
    "/:citizenID",
    passport.authenticate("jwt", { session: false }),
    censusServices.updatePeopleService,
);
